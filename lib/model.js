...
class MongooseOAuth2 {
  constructor() {
    let _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
      Client: _mongoose.OAuth2Client,
      Grant: _mongoose.OAuth2Grant,
      Group: _mongoose.OAuth2Group,
      Scope: _mongoose.OAuth2Scope,
      Token: _mongoose.OAuth2Token,
      User: _mongoose.OAuth2User
    },
        Client = _ref.Client,
        Grant = _ref.Grant,
        Group = _ref.Group,
